...
public class Chart2 extends Callable {
	...
	protected void getChart() throws Exception {
		...
		if (reportCode.equalsIgnoreCase("businesskpi")) {
			...
			if (loginName.equalsIgnoreCase("superadmin") || loginName.equalsIgnoreCase("admin") || type.equalsIgnoreCase("admin")){
			...
			tableName = "VIEW_Sales_SYTarget";
			if (loginName.equalsIgnoreCase("superadmin") || loginName.equalsIgnoreCase("admin") || type.equalsIgnoreCase("admin")){
				if (BLANKSTR.equals(supervisor) && BLANKSTR.equals(csf)){
					otherFilter = " SaleCode = 'U105781_admin'" ;
