	...
	theme: {
		...
		dimension: [
		    {code: "md_peroid", text: "期间", fields: [
       		    {caption: "年份", field: "year", filterField: "year", type:'select',
                    defaultvalue:[
    		    ...
    		    {caption: "月份", field: "month", filterField: "month",type:'select',
                    defaultvalue:[
		...
		value: [
		    {caption: "销量", field: "Quantity",defaultadded:true,},
		    {caption: "YTD销售额", field: "Amount",},
