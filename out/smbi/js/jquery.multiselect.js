...
(function($, undefined) {
  ...
  $.widget("ech.multiselect", {
    ...
    _create: function() {
      ...
      var button = (this.button = $('<button type="button"><span class="ui-icon ui-icon-triangle-1-s"></span></button>'))
        ...
        headerLinkContainer = (this.headerLinkContainer = $('<ul />'))
          ...
          .html(function() {
            if(o.header === true) {
              return '<li><a class="ui-multiselect-all" style="font-size:14px"  href="#"><span class="ui-icon ui-icon-check"></span><span>' + o.checkAllText + '</span></a></li><li><a class="ui-multiselect-none" style="font-size:14px" href="#"><span class="ui-icon ui-icon-closethick"></span><span>' + o.uncheckAllText + '</span></a></li>';
    ...
    setChecked: function (codes) {
        if(!codes) {
          return;
        }
        var inputs = this.menu.find('input')
        if(codes instanceof String) {
            var chedked = inputs.fliter("[value="+codes+"]");
            chedked.prop("checked", !chedked.prop("checked") );
        }else if(codes instanceof Array){
          for(var i = 0; i < codes.length; i++) {
            var one = codes[i];
              var chedked = inputs.fliter("[value="+one+"]");
              chedked.prop("checked", !chedked.prop("checked") );
          }
        }
