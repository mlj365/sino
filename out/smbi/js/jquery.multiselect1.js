...
(function($, undefined) {
  ...
  /**
   ...
   options: {
      ...
      buttonWidth: 145,                   // (integer | string | 'auto' | null) Sets the min/max/exact width of the button.
      menuWidth: null,                    // (integer | string | 'auto' | null) If a number is provided, sets the exact menu width.
      menuHeight: 175,                    // (integer | string | 'auto' | 'size') Sets the height of the menu or determines it using native select's size setting.
      ...
      selectedList: 1,                    // (integer) The actual list selections will be shown in the button when the count of selections is <= than this number.
      ...
      listbox: null,                     // (true | false) Omits the button and instead of a pop-up inserts the open menu directly after the native select as a list box.
