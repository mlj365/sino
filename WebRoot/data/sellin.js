		...
		dimension: [
		    {code: "period", text: "期间", fields: [
			 ...
			 {code: "hierarchy", text: "架构", fields: [
			    {caption: "主管", field: "hierarchy1", type: "select", defaultvalue:[{code:"All",name:"All"},{code:"RichardYang",name:"RichardYang"},{code:"EvenLiu",name:"EvenLiu"}]},                      
			    {caption: "负责销售", field: "hierarchy", type: "select", defaultvalue:[{code:"All",name:"All"},{code:"CocoMao",name:"CocoMao"},{code:"MessiMei",name:"MessiMei"}]}                      
			 ]},
			 ...
			 {code: "customer", text: "客户", fields: [
  			    ...
  			    {caption: "客户母公司", field: "customerName", filterField: "customerid"},
  			 ]},
