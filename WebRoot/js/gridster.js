/*! gridster.js - v0.7.0 - 2016-02-26 - * https://dsmorse.github.io/gridster.js/ - Copyright (c) 2016 ducksboard; Licensed MIT */!function(a, b) {
    ...
    c.set = function(a, b) {
        ...
        c && a && !b) {
            var d = c.offset();
            this.data.top = d.top,
            this.data.left = d.left
        }
        var e = this.data;
        return void 0 === e.left && (e.left = e.x1),
        void 0 === e.top && (e.top = e.y1),
        this.coords.x1 = e.left,
        this.coords.y1 = e.top,
        this.coords.x2 = e.left + e.width,
        this.coords.y2 = e.top + e.height,
        this.coords.cx = e.left + e.width / 2,
...
function(a, b) {
    ...
    h.draggable = function() {
        var b = this
          , c = a.extend(!0, {}, this.options.draggable, {
            ...
            limit: !0,
            start: function(c, d) {
                b.$widgets.filter(".player-revert").removeClass("player-revert"),
                b.$player = a(this),
                b.$helper = a(d.$helper),
            ...
            stop: function(a, c) {
                ...
                b.$el.trigger("gridster:dragstop")
            },
            drag: throttle(function(a, c) {
                b.on_drag.call(b, a, c),
                b.$el.trigger("gridster:drag")
            }, 60)
        });
    ...
    h.is_in_queue = function(a, b, c) {
        ...
        if (e in this.w_queue)
            if ("full" === this.w_queue[e])
                d = !0;
            else {
                var f = this.w_queue[e]
                  , g = f.coords().grid;
                this.is_widget_under_player(g.col, g.row) ? this.w_queue[e].attr("data-col") === c.attr("data-col") && this.w_queue[e].attr("data-row") === c.attr("data-row") ? (delete this.w_queue[e],
                d = !1) : d = !0 : (delete this.w_queue[e],
                d = !1)
            }
        return d
    }
    ...
    h.widgets_constraints = function(b) {
        ...
        return b.each(a.proxy(function(b, c) {
            var d = a(c)
              , h = d.coords().grid;
            this.can_go_widget_up(h) ? (e = e.add(d),
            f.push(h)) : g.push(h)
        }, this)),
        c = b.not(e),
        {
            can_go_up: d.sort_by_row_asc(f),
            can_not_go_up: d.sort_by_row_desc(g)
        }
    }
    ,
    h.manage_movements = function(b, c, d) {
        return a.each(b, a.proxy(function(a, b) {
            ...
            if (g)
                this.move_widget_to(f, g),
                this.set_placeholder(c, g + e.size_y);
            else {
                var h = this.can_go_player_up(this.player_grid_data);
                if (!h) {
                    var i = d + this.player_grid_data.size_y - e.row;
                    this.can_go_down(f) && (console.log("In Move Down!"),
                    this.move_widget_down(f, i),
                    this.set_placeholder(c, d))
                }
            }
        }, this)),
        this
    ...
    h.is_empty = function(a, b) {
        return "undefined" != typeof this.gridmap[a] ? "undefined" != typeof this.gridmap[a][b] && this.gridmap[a][b] === !1 : !0
    }
    ,
    h.is_valid_col = function(a, b) {
        return this.options.max_cols === 1 / 0 ? !0 : this.cols >= this.calculate_highest_col(a, b)
    }
    ,
    ...
    ,
    h.is_occupied = function(a, b) {
        return this.gridmap[a] ? !!this.gridmap[a][b] : !1
    }
    ,
    ...
    h.is_static = function(a, b) {
        var c = this.gridmap[a];
        return c ? (c = c[b],
        !(!c || !c.hasClass(this.options.static_class))) : !1
    }
    ,
    ...
    h.set_placeholder = function(b, c) {
        ...
        if (this.placeholder_grid_data.col = b,
        this.placeholder_grid_data.row = c,
        this.cells_occupied_by_placeholder = this.get_cells_occupied(this.placeholder_grid_data),
        ...
        this.options.shift_player_up) {
            if (f || g) {
                var h = this.widgets_below({
                    col: d.col,
                    row: d.row,
                    size_y: d.size_y,
                    size_x: d.size_x
                });
                h.each(a.proxy(function(b, c) {
                    var d = a(c)
                      , e = d.coords().grid
    ...
    h.can_go_player_up = function(a) {
        ...
        return this.for_each_column_occupied(a, function(a) {
            var g = this.gridmap[a]
              , h = b + 1;
            for (d[a] = []; --h > 0 && (this.is_empty(a, h) || this.is_player(a, h) || this.is_widget(a, h) && g[h].is(f)); )
                d[a].push(h),
                e = e > h ? h : e;
            return 0 === d[a].length ? (c = !1,
            !0) : void d[a].sort(function(a, b) {
                return a - b
            })
        }),
    ...
    h.can_go_widget_up = function(a) {
        ...
        return this.for_each_column_occupied(a, function(f) {
            ...
            d[f] = [];
            for (var h = b + 1; --h > 0 && (!this.is_widget(f, h) || this.is_player_in(f, h) || g[h].is(a.el)); )
                this.is_player(f, h) || this.is_placeholder_in(f, h) || this.is_player_in(f, h) || d[f].push(h),
                e > h && (e = h);
            return 0 === d[f].length ? (c = !1,
            !0) : void d[f].sort(function(a, b) {
                return a - b
            })
        }),
        c ? this.get_valid_rows(a, d, e) : !1
    ...
    h.get_widgets_overlapped = function() {
        ...
        return d.reverse(),
        a.each(this.cells_occupied_by_player.cols, a.proxy(function(e, f) {
    ...
    h.on_stop_overlapping_row = function(a) {
        ...
        if (this.options.shift_larger_widgets_down)
            for (var d = 0, e = c.length; e > d; d++)
                this.for_each_widget_below(c[d], a, function(a, c) {
                    b.move_widget_up(this, b.player_grid_data.size_y)
                })
    }
    ,
    h.new_move_widget_to = function(a, b, c) {
        var d = a.coords().grid;
        return this.remove_from_gridmap(d),
        d.row = c,
        d.col = b,
        this.add_to_gridmap(d),
        a.attr("data-row", c),
        a.attr("data-col", b),
        this.update_widget_position(d, a),
        this.$changed = this.$changed.add(a),
        this
    }
    ,
    ...
    h.move_widget_to = function(b, c) {
        var d = this
          ...
          , g = this.can_move_to(e, e.col, c);
        return g === !1 ? !1 : (this.remove_from_gridmap(e),
        e.row = c,
        this.add_to_gridmap(e),
        b.attr("data-row", c),
        this.$changed = this.$changed.add(b),
        f.each(function(b, c) {
            var e = a(c)
              , f = e.coords().grid
    ...
    h.move_widget_up = function(b, c) {
        ...
        var d = b.coords().grid
          ...
          , f = [];
        return c || (c = 1),
        this.can_go_up(b) ? void this.for_each_column_occupied(d, function(d) {
            if (-1 === a.inArray(b, f)) {
                var g = b.coords().grid
                  , h = e - c;
                if (h = this.can_go_up_to_row(g, d, h),
                !h)
                    return !0;
                this.remove_from_gridmap(g),
                g.row = h,
                this.add_to_gridmap(g),
                b.attr("data-row", g.row),
                this.$changed = this.$changed.add(b),
                f.push(b)
            }
        }) : !1
    ...
    h.move_widget_down = function(b, c) {
        ...
        if (-1 === a.inArray(b, f)) {
            ...
            this.remove_from_gridmap(h),
            j.each(a.proxy(function(b, c) {
                var d = a(c)
                  , e = d.coords().grid
            ...
            h.row = i,
            this.update_widget_position(h, b),
            b.attr("data-row", h.row),
            this.$changed = this.$changed.add(b),
            f.push(b)
        }
    }
    ...
    h.can_go_up_to_row = function(b, c, d) {
        ...
        if (this.for_each_column_occupied(b, function(a) {
            for (g[a] = [],
            e = h; e-- && this.is_empty(a, e) && !this.is_placeholder_in(a, e); )
                g[a].push(e);
            return g[a].length ? void 0 : (f = !1,
            !0)
        }),
        !f)
            return !1;
        for (e = d,
        e = 1; h > e; e++) {
            for (var i = !0, j = 0, k = g.length; k > j; j++)
                g[j] && -1 === a.inArray(e, g[j]) && (i = !1);
            if (i === !0) {
                f = e;
                break
            }
    ...
    h.displacement_diff = function(a, b, c) {
        ...
        this.for_each_column_occupied(a, function(a) {
            for (var b = 0, c = f; d > c; c++)
                this.is_empty(a, c) && (b += 1);
            e.push(b)
        });
    ...
    h.widgets_below = function(b) {
        ...
        return this.for_each_column_occupied(e, function(b) {
            f.for_each_widget_below(b, g, function(b, d) {
                return f.is_player(this) || -1 !== a.inArray(this, c) ? void 0 : (c = c.add(this),
                !0)
            })
        }),
        d.sort_by_row_asc(c)
    ...
    h.set_cells_player_occupies = function(a, b) {
        return this.remove_from_gridmap(this.placeholder_grid_data),
        this.placeholder_grid_data.col = a,
        this.placeholder_grid_data.row = b,
    ...
    h.can_go_down = function(b) {
        var c = !0
          , d = this;
        return b.hasClass(this.options.static_class) && (c = !1),
        this.widgets_below(b).each(function() {
    ...
    h.can_move_to = function(a, b, c) {
        ...
        return this.options.max_rows < c + a.size_y - 1 ? !1 : (this.for_each_cell_occupied(e, function(b, c) {
    ...
    h.get_targeted_columns = function(a) {
        for (var b = (a || this.player_grid_data.col) + (this.player_grid_data.size_x - 1), c = [], d = a; b >= d; d++)
            c.push(d);
        return c
    }
    ,
    h.get_targeted_rows = function(a) {
        for (var b = (a || this.player_grid_data.row) + (this.player_grid_data.size_y - 1), c = [], d = a; b >= d; d++)
            c.push(d);
        return c
    }
    ,
    h.get_cells_occupied = function(b) {
        ...
        for (arguments[1] instanceof a && (b = arguments[1].coords().grid),
        c = 0; c < b.size_x; c++) {
            var e = b.col + c;
            d.cols.push(e)
        }
            ...
            var l = []
              ...
              , n = {
                ...
                "for_each/below": function() {
                    for (m = e + 1,
                    i = g[d].length; i > m; m++)
                        this.is_widget(d, m) && -1 === a.inArray(g[d][m], l) && (h = f.call(g[d][m], d, m),
                        l.push(g[d][m]))
                }
            };
            n[j] && n[j].call(this)
    ...
    h.for_each_widget_above = function(a, b, c) {
        return this._traversing_widgets("for_each", "above", a, b, c),
        this
    }
    ,
    h.for_each_widget_below = function(a, b, c) {
        return this._traversing_widgets("for_each", "below", a, b, c),
        this
    }
    ,
    ...
    h.get_widgets_in_range = function(b, c, d, e) {
        ...
        for (f = d; f >= b; f--)
            for (g = e; g >= c; g--)
                h = this.is_widget(f, g),
                h !== !1 && (i = h.data("coords").grid,
                i.col >= b && i.col <= d && i.row >= c && i.row <= e && (j = j.add(h)));
        return j
    }
    ,
    ...
    h.set_dom_grid_height = function(a) {
        ...
        return this.container_height = a,
    ...
    h.set_dom_grid_width = function(a) {
        ...
        return a = Math.min(b, Math.max(a, this.options.min_cols)),
        this.container_width = (a + 1) * this.options.widget_margins[0] + a * this.min_widget_width,
        this.is_responsive() ? (this.$el.css({
            "min-width": "100%",
            "max-width": "100%"
        }),
        this) : (this.$el.css("width", this.container_width),
        this)
    }
    ,
    ...
    h.resize_responsive_layout = function() {
        return this.min_widget_width = this.get_responsive_col_width(),
    ...
    h.toggle_collapsed_grid = function(a, b) {
        ...
        this.resize_api && this.disable_resize(),
        this.drag_api && this.disable()) : (this.$widgets.css({
            "margin-top": "auto",
            "margin-bottom": "auto",
            "min-height": "auto"
        }),
        this.$el.removeClass("collapsed"),
        this.resize_api && this.enable_resize(),
        this.drag_api && this.enable()),
        this
    }
    ,
    h.generate_stylesheet = function(b) {
        var c, e = "", f = this.is_responsive() && this.options.responsive_breakpoint && a(window).width() < this.options.responsive_breakpoint;
        b || (b = {}),
        b.cols || (b.cols = this.cols),
        b.rows || (b.rows = this.rows),
        b.namespace || (b.namespace = this.options.namespace),
        b.widget_base_dimensions || (b.widget_base_dimensions = this.options.widget_base_dimensions),
        b.widget_margins || (b.widget_margins = this.options.widget_margins),
        this.is_responsive() && (b.widget_base_dimensions = [this.get_responsive_col_width(), b.widget_base_dimensions[1]],
        this.toggle_collapsed_grid(f, b));
        var g = a.param(b);
        if (a.inArray(g, d.generated_stylesheets) >= 0)
            return !1;
        for (this.generated_stylesheets.push(g),
        d.generated_stylesheets.push(g),
        c = 1; c <= b.cols + 1; c++)
            e += b.namespace + ' [data-col="' + c + '"] { left:' + (f ? this.options.widget_margins[0] : c * b.widget_margins[0] + (c - 1) * b.widget_base_dimensions[0]) + "px; }\n";
        for (c = 1; c <= b.rows + 1; c++)
            e += b.namespace + ' [data-row="' + c + '"] { top:' + (c * b.widget_margins[1] + (c - 1) * b.widget_base_dimensions[1]) + "px; }\n";
        for (var h = 1; h <= b.rows; h++)
            e += b.namespace + ' [data-sizey="' + h + '"] { height:' + (f ? "auto" : h * b.widget_base_dimensions[1] + (h - 1) * b.widget_margins[1]) + (f ? "" : "px") + "; }\n";
        ...
        return this.remove_style_tags(),
        this.add_style_tag(e)
    }
    ,
    h.add_style_tag = function(a) {
        var b = document
          , c = "gridster-stylesheet";
        if ("" !== this.options.namespace && (c = c + "-" + this.options.namespace),
        !document.getElementById(c)) {
            ...
            this.$style_tags = this.$style_tags.add(d)
        }
        return this
    }
    ,
    h.remove_style_tags = function() {
        ...
        d.generated_stylesheets = a.map(b, function(b) {
    ...
    h.add_faux_cell = function(b, c) {
        ...
        return a.isArray(this.gridmap[c]) || (this.gridmap[c] = []),
        "undefined" == typeof this.gridmap[c][b] && (this.gridmap[c][b] = !1),
        this.faux_grid.push(d),
        this
    }
    ,
    h.add_faux_rows = function(a) {
        ...
        for (var b = this.rows, c = b + parseInt(a || 1), d = c; d > b; d--)
            for (var e = this.cols; e >= 1; e--)
                this.add_faux_cell(d, e);
        return this.rows = c,
        this.options.autogenerate_stylesheet && this.generate_stylesheet(),
        this
    }
    ,
    h.add_faux_cols = function(a) {
        ...
        for (var d = b + 1; c >= d; d++)
            for (var e = this.rows; e >= 1; e--)
                this.add_faux_cell(e, d);
        return this.cols = c,
        this.options.autogenerate_stylesheet && this.generate_stylesheet(),
        this
    }
    ...
    h.recalculate_faux_grid = function() {
        ...
        return this.baseX = (f.width() - b) / 2,
        this.baseY = this.$wrapper.offset().top,
        "relative" === this.$wrapper.css("position") && (this.baseX = this.baseY = 0),
        ...
        this.is_responsive() && this.resize_responsive_layout(),
        this.options.center_widgets && this.center_widgets(),
        this
    }
    ,
    h.resize_widget_dimensions = function(b) {
        return b.widget_margins && (this.options.widget_margins = b.widget_margins),
        b.widget_base_dimensions && (this.options.widget_base_dimensions = b.widget_base_dimensions),
        ...
        this.$widgets.each(a.proxy(function(b, c) {
            var d = a(c);
    ...
    h.get_widgets_from_DOM = function() {
        ...
        b = d.sort_by_row_and_col_asc(b);
        var c = a(b).map(a.proxy(function(a, b) {
            return this.register_widget(b) || null 
        }, this));
        return c.length && this.$el.trigger("gridster:positionschanged"),
        this
    }
    ,
    ...
    h.set_num_columns = function(b) {
        ...
        this.cols = Math.max(f, d, this.options.min_cols),
        c !== 1 / 0 && c >= f && c < this.cols && (this.cols = c),
        this.drag_api && this.drag_api.set_limits(this.cols * this.min_widget_width + (this.cols + 1) * this.options.widget_margins[0])
    }
    ,
    ...
    h.destroy = function(b) {
        return this.$el.removeData("gridster"),
        a.each(this.$widgets, function() {
            a(this).removeData("coords")
        }),
        f.unbind(".gridster"),
        this.drag_api && this.drag_api.destroy(),
        this.resize_api && this.resize_api.destroy(),
        this.$widgets.each(function(b, c) {
            a(c).coords().destroy()
        }),
        this.resize_api && this.resize_api.destroy(),
        this.remove_style_tags(),
